...
execute store result score @s de_cl0 run data get entity @e[tag=de_rty950t4rer,limit=1] Pos[0]
execute store result score @s de_cl1 run data get entity @e[tag=de_rty950t4rer,limit=1] Pos[1]
execute store result score @s de_cl2 run data get entity @e[tag=de_rty950t4rer,limit=1] Pos[2]
scoreboard players operation @s de_cl3 = 56hijerkfge de_cache
scoreboard players operation @s de_cl4 = 54t4trt345r de_cache
scoreboard players operation @s de_cl5 = 5yr5rte54te de_cache
...
scoreboard players operation @s de_cl0 += retg7dgrfdr de_cache
scoreboard players operation @s de_cl1 += dfv2fdrgge4 de_cache
scoreboard players operation @s de_cl2 += 45645tgrtg5 de_cache
