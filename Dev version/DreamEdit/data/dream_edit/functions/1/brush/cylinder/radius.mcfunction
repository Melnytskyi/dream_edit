...
execute if score check_border de_cache matches 1 as @e[tag=de_check_region,limit=1,sort=nearest] run function dream_edit:1/border/check_allow_position
...
execute if score 14 de_cache < de_br_radius de_cache positioned ^ ^ ^1 run function dream_edit:1/brush/cylinder/radius