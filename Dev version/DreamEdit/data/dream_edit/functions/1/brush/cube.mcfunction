...
execute store result score lalala de_cache run data get entity @e[tag=de_vbklgbnfdfv,limit=1] Pos[0]
execute store result score lalalo de_cache run data get entity @e[tag=de_vbklgbnfdfv,limit=1] Pos[1]
execute store result score lalal0 de_cache run data get entity @e[tag=de_vbklgbnfdfv,limit=1] Pos[2]
...
scoreboard players operation lalala de_cache = @s de_brush_val_0
scoreboard players operation lalalo de_cache = @s de_brush_val_1
scoreboard players operation lalal0 de_cache = @s de_brush_val_2
scoreboard players operation 0 de_cache += lalala de_cache
scoreboard players operation 1 de_cache += lalalo de_cache
scoreboard players operation 2 de_cache += lalala de_cache
scoreboard players operation 00 de_cache -= lalala de_cache
scoreboard players operation 10 de_cache -= lalal0 de_cache
...
execute as @e[tag=de_vrjrjrjrjrjp] run function dream_edit:0/area_runer/fill_random/1