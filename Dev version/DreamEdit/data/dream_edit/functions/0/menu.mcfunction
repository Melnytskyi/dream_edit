...
execute as @s[tag=de_snow] run tellraw @s ["",{"translate":"dream_edit.menu.snow.op","color":"dark_aqua"},{"text":"\n"},{"translate":"dream_edit.menu.snow.smoothing","color":"gray","clickEvent":{"action":"run_command","value":"/function dream_edit:0/menu/snow_s"}},{"text":" "},{"translate":"dream_edit.menu.snow.noisy","color":"dark_gray","clickEvent":{"action":"run_command","value":"/function dream_edit:0/menu/snow_n"}},{"text":" "},{"translate":"dream_edit.menu.snow.flattening","color":"gray","clickEvent":{"action":"run_command","value":"/function dream_edit:0/menu/snow_f"}}]
...
tellraw @s ["\n",{"text":"{{","color":"dark_green","bold":true},{"text":"Dream World Editor","color":"dark_aqua","bold":true},{"text":"}}","color":"dark_green","bold":true}]
function dream_edit:0/menus/page_menu
execute if score @s de_page matches ..0 run function dream_edit:0/menus/0
execute if score @s de_page matches 1 run function dream_edit:0/menus/1
execute if score @s de_page matches 2 run function dream_edit:0/menus/2
execute if score @s de_page matches 3 run function dream_edit:0/menus/mode
execute if score @s de_page matches 4 run function dream_edit:0/menus/another
execute if score @s de_page matches 5.. run function dream_edit:0/menus/region
function dream_edit:0/menus/page_flor
