...
setblock 29999999 0 0 chest{Items:[{id:"minecraft:stick",Count:1b,tag:{display:{Name:'{"text":"Dream Edit - Parandora Box","italic":"false"}'},dream_edit:{area_data:1}}}],Lock:"trgb35609gd8989340f8@%^&#g5rp"}
setblock 29999999 5 0 air
setblock 29999999 5 0 chest{Items:[{id:"minecraft:stick",Count:1b,tag:{display:{Name:'{"text":"Dream Edit","italic":"false"}'},dream_edit:{area_data:1}}}],Lock:"yh6@h56r@#ttfh&^*O#YG#^D68gv5"}
...
execute if score chunk de_cache matches 0 run function dream_edit_crypto:menu_null
...
scoreboard players set 67jyuj de_cache 1
data modify block 29999999 0 0 Items[0].tag.DreamEdit_datar.crypted set value 1
...
execute if score psd1 de_cache matches 255.. if score psd2 de_cache matches 15.. if score psd0 de_cache matches ..29999984 run scoreboard players set 67jyuj de_cache 0
execute as @e[tag=de_is_saving,limit=1] at @s if score 67jyuj de_cache matches 1 unless block ~ ~ ~ chest run clone 29999999 0 0 29999999 0 0 ~ ~ ~
execute as @e[tag=de_is_saving,limit=1] at @s if score 67jyuj de_cache matches 1 if block ~ ~ ~ chest run data modify block ~ ~ ~ Items[0] set from block 29999999 0 0 Items[0]
tag @e remove de_exporting
tag @s remove de_3op3dze4c
execute if score gamerule de_cache matches 0 store result score gamerule de_cache run gamerule sendCommandFeedback
gamerule sendCommandFeedback false
function dream_edit:main_lib/under_op
scoreboard players reset decrypt0 de_cache 
scoreboard players reset decrypt1 de_cache 
scoreboard players reset decrypt2 de_cache 