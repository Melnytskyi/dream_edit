...
execute at @s unless block ~ ~-1 ~ #dream_edit:air if block ~ ~ ~ #dream_edit:air run function dream_edit:0/area_runer/top_soli_clone/5
scoreboard players operation @s de_sel_y += -1 de_cache
execute if score -1 de_cache matches ..-1 if score @s de_sel_y >= @s de_op_2 run function dream_edit:0/area_runer/top_soli_clone/4
execute if score -1 de_cache matches 1.. if score @s de_sel_y <= @s de_op_2 run function dream_edit:0/area_runer/top_soli_clone/4