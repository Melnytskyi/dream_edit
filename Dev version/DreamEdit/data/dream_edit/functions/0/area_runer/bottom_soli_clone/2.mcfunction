...
execute if score @s de_sel_z <= @s de_op_1 run function dream_edit:0/area_runer/bottom_soli_clone/3
scoreboard players add @s de_sel_x 1
execute if score @s de_sel_x <= @s de_op_0 run function dream_edit:0/area_runer/bottom_soli_clone/2