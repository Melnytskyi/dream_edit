...
execute as @e[tag=de_vrjrjrjrjrjp] unless score chunk de_cache matches 0 run function dream_edit:0/area_runer/smooth/5x5_use_under_select_point/1
execute as @e[tag=de_trghr5hrthb_set] at @s run function dream_edit:0/area_runer/smooth/5x5/5
