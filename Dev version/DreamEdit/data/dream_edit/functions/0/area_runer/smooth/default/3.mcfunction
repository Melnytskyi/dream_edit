...
execute at @s run function dream_edit:0/area_runer/smooth/default/points/2
execute at @s if block ~ ~ ~ air run function dream_edit:0/area_runer/smooth/default/points/0
execute at @s run function dream_edit:0/area_runer/smooth/default/4

scoreboard players add @s de_sel_z 1
execute if score @s de_sel_z <= @s de_op_1 run function dream_edit:0/area_runer/smooth/default/3
#say 2