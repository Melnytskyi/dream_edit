execute if block ~ ~ ~ acacia_button[facing=north] run data modify block 29999999 5 0 Items[0].tag.DreamEdit_bdata set value {a:"2",b:"acacia_button",f:{i:"0"},p:{i:"0"}}
execute if block ~ ~ ~ acacia_button[facing=east] run data modify block 29999999 5 0 Items[0].tag.DreamEdit_bdata set value {a:"3",b:"acacia_button",f:{i:"0"},p:{i:"0"}}
execute if block ~ ~ ~ acacia_button[facing=west] run data modify block 29999999 5 0 Items[0].tag.DreamEdit_bdata set value {a:"4",b:"acacia_button",f:{i:"0"},p:{i:"0"}}
execute if block ~ ~ ~ acacia_button[facing=south] run data modify block 29999999 5 0 Items[0].tag.DreamEdit_bdata set value {a:"5",b:"acacia_button",f:{i:"0"},p:{i:"0"}}
