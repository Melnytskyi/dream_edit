...
execute as @e[tag=de_vrjrjrjrjrjp] unless score chunk de_cache matches 0 if entity @e[tag=de_pool] run function dream_edit:0/area_runer/replace_random_air/1
