...
execute store result entity @s Pose.Head[0] float 0.00001 run scoreboard players get nbt_res_rot_y de_cache
execute store result entity @s Pose.Head[1] float 0.00001 run scoreboard players get nbt_res_rot_x de_cache
