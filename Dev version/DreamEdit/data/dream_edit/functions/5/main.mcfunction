scoreboard players set @s de_tool 5
...
execute as @s[scores={de_nbt_op_armor=1..7}] as @e[type=armor_stand] if score @s de_nbt_edit_id = @p[tag=de_nx43zl4e] de_pid run function dream_edit:2/visual/folow
execute as @s[scores={de_v_t=1..}] at @s run function dream_edit:2/visual/rpoint
execute as @e[tag=de_f4nneipof,limit=1] at @s run function dream_edit:2/visual/detect_click
