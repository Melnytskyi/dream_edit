...
scoreboard players operation 0 de_cache = @s de_artbmax
scoreboard players operation 00 de_cache = @s de_artbmix
scoreboard players operation 1 de_cache = @s de_artbmay
scoreboard players operation 10 de_cache = @s de_artbmiy
scoreboard players operation 2 de_cache = @s de_artbmaz
scoreboard players operation 20 de_cache = @s de_artbmiz
...
execute as @e[tag=de_vrjrjrjrjrjp] run function dream_edit:3/op/apool/1
