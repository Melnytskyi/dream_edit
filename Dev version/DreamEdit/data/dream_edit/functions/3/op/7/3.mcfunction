...
execute if score -1 de_cache matches ..-1 if score @s de_sel_y >= @s de_op_2 run function dream_edit:3/op/7/4
execute if score -1 de_cache matches 1.. if score @s de_sel_y <= @s de_op_2 run function dream_edit:3/op/7/4
scoreboard players add @s de_sel_z 1
execute if score @s de_sel_z <= @s de_op_1 run function dream_edit:3/op/7/3
#say 2