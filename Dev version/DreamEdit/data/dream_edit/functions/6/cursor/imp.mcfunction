...
scoreboard players operation de_ix1 de_cache += @s de_ism_x
scoreboard players operation de_iy1 de_cache += @s de_ism_y
scoreboard players operation de_iz1 de_cache += @s de_ism_z
