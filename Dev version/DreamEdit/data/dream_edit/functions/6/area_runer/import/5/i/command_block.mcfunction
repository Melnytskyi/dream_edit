execute if data block 29999999 255 0 {Items:[{tag:{DreamEdit_rdata:{a:"0"}}}]} run setblock ~ ~ ~ command_block[facing=up]  
execute if data block 29999999 255 0 {Items:[{tag:{DreamEdit_rdata:{a:"1"}}}]} run setblock ~ ~ ~ command_block[facing=down]     
execute if data block 29999999 255 0 {Items:[{tag:{DreamEdit_rdata:{a:"2"}}}]} run setblock ~ ~ ~ command_block[facing=north]    
execute if data block 29999999 255 0 {Items:[{tag:{DreamEdit_rdata:{a:"3"}}}]} run setblock ~ ~ ~ command_block[facing=east]     
execute if data block 29999999 255 0 {Items:[{tag:{DreamEdit_rdata:{a:"4"}}}]} run setblock ~ ~ ~ command_block[facing=west]     
execute if data block 29999999 255 0 {Items:[{tag:{DreamEdit_rdata:{a:"5"}}}]} run setblock ~ ~ ~ command_block[facing=south]    
